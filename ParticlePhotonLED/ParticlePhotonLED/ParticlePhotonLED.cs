...
namespace ParticlePhotonLED
{
    public class App : Application
    {
        public App()
        {
			var ChangeLedCommand = new Command<string>(ChangeLed);
			var onButton = new Button{ Text = "ON", Command=ChangeLedCommand };
			var offButton = new Button { Text = "OFF" };
   ...
   //             }
        ...
        public void ChangeLed(string changeValue="on")
        {
